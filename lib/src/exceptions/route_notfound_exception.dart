...
void badRequestException(HttpResponse response, String message) {
  response
    ..statusCode = HttpStatus.badRequest
    ..headers.contentType = ContentType.html
    ..write(
        '<!DOCTYPE html> <html lang="en"> <head> <meta charset="utf-8"> <title>Error</title></head><body><pre>Bad Request - $message</pre></body></html>')
    ..close();
}
